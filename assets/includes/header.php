...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>Concave Energy - Welcome</title>
            ...
            <div class="container-medium">
                ...
                <!-- <div class="attr-nav">
                    <ul>
                        ...
                        <li class="btn"><a href="#">Get quote</a></li>
                    </ul>
                </div>         -->
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">
                        <img src="assets/img/logo-light.png" class="logo logo-display" alt="Logo" width="250px">
                        <img src="assets/img/logo.png" class="logo logo-scrolled" alt="Logo" width="250px">
                    </a>
                </div>
